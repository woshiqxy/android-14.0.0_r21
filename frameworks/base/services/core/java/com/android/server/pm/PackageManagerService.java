...
public class PackageManagerService implements PackageSender, TestUtilityService {
    ...
    public static PackageManagerService main(Context context,
        ...
        //专门用于安装操作的锁，与主锁分离以减少竞争
        final Object installLock = new Object();

        //后台线程创建,创建专用的后台线程处理 I/O 密集型任务,优先级设为 BACKGROUND，避免影响 UI 响应
        ...
        //PMS 实例化
        //factoryTest: 是否处于工厂测试模式
        //FINGERPRINT: 系统构建指纹
        //IS_ENG/IS_USERDEBUG: 构建类型标识
        //SDK_INT: 目标 SDK 版本
        //INCREMENTAL: 增量版本号
