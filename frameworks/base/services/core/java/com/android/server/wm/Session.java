...
class Session extends IWindowSession.Stub implements IBinder.DeathRecipient {
    final WindowManagerService mService;// 持有WMS引用
    ...
    public int addToDisplayAsUser(IWindow window, WindowManager.LayoutParams attrs,
        ...
        return mService.addWindow(
                this,                    // Session自身
                window,                  // IWindow (App回调)
                attrs,                   // LayoutParams
                viewVisibility,          // 可见性
                displayId,               // 目标Display
                userId,                  // 用户ID
                requestedVisibleTypes,   // 请求可见的Insets类型
                outInputChannel,         // [输出] InputChannel
                outInsetsState,          // [输出] InsetsState
                outActiveControls,       // [输出] InsetsSourceControl
                outAttachedFrame,        // [输出] 附着Frame
                outSizeCompatScale       // [输出] 兼容缩放
        );
    }
