...
public final class WindowManagerGlobal {
    ...
    // 三个核心列表（一一对应）
    @UnsupportedAppUsage
    private final ArrayList<View> mViews = new ArrayList<View>();// DecorView列表
    @UnsupportedAppUsage
    private final ArrayList<ViewRootImpl> mRoots = new ArrayList<ViewRootImpl>(); // ViewRootImpl列表
    @UnsupportedAppUsage
    private final ArrayList<WindowManager.LayoutParams> mParams =
            new ArrayList<WindowManager.LayoutParams>();// 参数列表
    ...
    /**
     * 关键点：
     * 创建了 ViewRootImpl（每个窗口一个）
     * 调用 root.setView() 进入核心逻辑
     * @param view
     * @param params
     * @param display
     * @param parentWindow
