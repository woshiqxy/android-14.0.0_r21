...
public final class ViewRootImpl implements ViewParent,
    ...
    public ViewRootImpl(@UiContext Context context, Display display, IWindowSession session,
        ...
        // 创建 W 对象 (IWindow的实现，WMS通过它回调App)
        mWindow = new W(this);
            ...
            if (mView == null) {
                ...
                try {
                    ...
                    res = mWindowSession.addToDisplayAsUser(
                            mWindow,           // IWindow: WMS回调App的接口
                            mWindowAttributes, // LayoutParams: 窗口参数
                            getHostVisibility(),
                            mDisplay.getDisplayId(),
                            userId,
                            mInsetsController.getRequestedVisibleTypes(),
                            inputChannel,      // 输出: Input事件通道
                            mTempInsets,        // 输出: InsetsState
                            mTempControls,      // 输出: InsetsSourceControl
                            attachedFrame,
                            compatScale);
                ...
                // ============ 第8步: 设置View的parent ============
                view.assignParent(this);  // ViewRootImpl成为DecorView的parent
